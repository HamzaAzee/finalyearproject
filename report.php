...
<form action="studentreport.php" method="POST" enctype="multipart/form-data">
<h1 id="sid">Report Complaint Below:</h1>
<label id="frwd">Report complaint:</label><br>
<textarea name="complaint" id="report"></textarea><br><br>
<button type="submit" class="btn btn-success" name="report" id="movie">Report</button>
</form>
</div>
</div></div>
