...
<div class="container">
<a class="navbar-brand" id="a">Upload Paid Fee Challan</a>
...
<form action="fmg.php" method="POST" enctype="multipart/form-data">
<h1 id="sid">Update Your Paid Fee Challan:</h1>
