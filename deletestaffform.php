...
<div class="container">
<a class="navbar-brand" id="a">Delete staff members</a>
...
<form class="field" method="POST" action="deletestaff.php"  enctype="multipart/form-data">
<h1 id="sid">Deal With Staff Here:</h1>

<label id="frwd2">Staff ID</label>
<input type="text" name="staffid" id="move4" placeholder="Enter Username" />
