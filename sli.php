...
<div class="container" id="ctr">
            	<ul class="dropdown">
				   ...
				   <a href="sliimg.html">Update Profile Image</a> <br>   <!--page required-->
				   <a href="passwordreset.html">Reset password</a>       <!--page required-->
				   </ul>
				   </div>
				</div>
...
<div class="container" id="ctr">
				<ul class="dropdown">
				   ...
				   <a href="slifeeimg.html">Upload Paid Fee Challan</a> <br> <!--page required-->
